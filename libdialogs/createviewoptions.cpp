...
CreateViewOptions::CreateViewOptions(wxWindow *parent, const Database *db) : wxDialog(parent, wxID_ANY, "")
{
    ...
    if( db->GetTableVector().m_type == L"Microsoft SQL Server" || ( db->GetTableVector().m_type == L"ODBC" && db->GetTableVector().m_subtype == L"Microsoft SQL Server" ) )
    {
        ...
        checkbox_1 = new wxCheckBox( m_panel, wxID_ANY, "Encryption" );
        sizer_9->Add( checkbox_1, 0, wxEXPAND, 0 );
        sizer_9->Add( 5, 5, 0, wxEXPAND, 0 );
        checkbox_2 = new wxCheckBox( m_panel, wxID_ANY, "Schema Binding" );
        sizer_9->Add( checkbox_2, 0, wxEXPAND, 0 );
        sizer_9->Add( 5, 5, 0, wxEXPAND, 0 );
        checkbox_3 = new wxCheckBox( m_panel, wxID_ANY, "View Metadata" );
        sizer_9->Add( checkbox_3, 0, wxEXPAND, 0 );
        sizer_9->Add( 5, 5, 0, wxEXPAND, 0 );
