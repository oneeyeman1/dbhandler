...
public:
    ...
    bool CreateDatabaseDocument(const wxString &path, ViewType type, Database *db, wxCriticalSection &cs, long flags = 0);
    DrawingView *CreateDatabaseView(wxDocument *doc, ViewType type, wxCriticalSection &cs, long flags = 0);
};
