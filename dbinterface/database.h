...
protected:
    ...
    virtual int GetTableId(DatabaseTable *table, std::vector<std::wstring> &errorMsg) = 0;
...
public:
    ...
    virtual int GetFieldProperties(const std::wstring &tableName, const std::wstring &schemaName, const std::wstring &ownerName, Field *table, std::vector<std::wstring> &errorMsg) = 0;
