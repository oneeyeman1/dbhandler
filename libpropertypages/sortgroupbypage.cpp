...
static const char handdrag_mask[] = {

    0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x00, 0x00, 0x01, 0x01, 0x00, 0x01, 0x01, 0x01, 0x00, 0x01,
    0x00, 0x00, 0x16, 0x00, 0x00, 0x00, 0x28, 0x00, 0x00, 0x00, 0x20, 0x00, 0x00, 0x00, 0x40, 0x00,
    0x00, 0x00, 0x01, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0x00, 0x00, 0x00, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0xff, 0xff, 0xff, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x3f, 0xf0, 0x00, 0x00, 0x3f,
...
#ifdef ___WXGTK__
    auto cursor = wxCursor( handdrag_cur, 32, 32, 6, 14, handdrag_mask, wxWHITE, wxBLACK );
#else
    auto cursor = wxCursor( "HANDDRAG_CUR" );
    if( cursor.IsOk() )
        wxMessageBox( "Good" );
    else
    {
        auto err = ::GetLastError();
        wxMessageBox( wxString::Format( "%d", err ), "Error" );
    }
#endif
