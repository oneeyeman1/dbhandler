...
/*            oracleQueries.push_back( L"MERGE INTO abcatedt t USING (SELECT 'BenefitsCheckBox' AS abe_name FROM DUAL) s INSERT VALUES( \'HH:MM:SS\', \'HH:MM:SS\', 90, 1, 1, 32, \'30\' );" );
            oracleQueries.push_back( L"MERGE INTO abcatedt t USING (SELECT 'BenefitsCheckBox' AS abe_name FROM DUAL) s INSERT VALUES( \'HH:MM:SS:FFF\', \'HH:MM:SS:FFF\', 90, 1, 1, 32, \'30\' );" );
            oracleQueries.push_back( L"MERGE INTO abcatedt t USING (SELECT 'BenefitsCheckBox' AS abe_name FROM DUAL) s INSERT VALUES( \'HH:MM:SS:FFFFFF\', \'HH:MM:SS:FFFFFF\', 90, 1, 1, 32, \'30\' );" );
            oracleQueries.push_back( L"MERGE INTO abcatedt t USING (SELECT 'BenefitsCheckBox' AS abe_name FROM DUAL) s INSERT VALUES( \'JJJ/YY\', \'JJJ/YY\', 90, 1, 1, 32, \'20\' );" );
            oracleQueries.push_back( L"MERGE INTO abcatedt t USING (SELECT 'BenefitsCheckBox' AS abe_name FROM DUAL) s INSERT VALUES( \'JJJ/YY HH:MM:SS\', \'JJJ/YY HH:MM:SS\', 90, 1, 1, 32, \'40\' );" );
            oracleQueries.push_back( L"MERGE INTO abcatedt t USING (SELECT 'BenefitsCheckBox' AS abe_name FROM DUAL) s INSERT VALUES( \'JJJ/YYYY\', \'JJJ/YYYY\', 90, 1, 1, 32, \'40\' );" );
            oracleQueries.push_back( L"MERGE INTO abcatedt t USING (SELECT 'BenefitsCheckBox' AS abe_name FROM DUAL) s INSERT VALUES( \'HH:MM:SS\', \'HH:MM:SS\', 90, 1, 1, 32, \'30\' );" );
            oracleQueries.push_back( L"MERGE INTO abcatedt t USING (SELECT 'BenefitsCheckBox' AS abe_name FROM DUAL) s INSERT VALUES( \'HH:MM:SS\', \'HH:MM:SS\', 90, 1, 1, 32, \'30\' );" );
            oracleQueries.push_back( L"MERGE INTO abcatedt t USING (SELECT 'BenefitsCheckBox' AS abe_name FROM DUAL) s INSERT VALUES( \'HH:MM:SS\', \'HH:MM:SS\', 90, 1, 1, 32, \'30\' );" );
            oracleQueries.push_back( L"MERGE INTO abcatedt t USING (SELECT 'BenefitsCheckBox' AS abe_name FROM DUAL) s INSERT VALUES( \'HH:MM:SS\', \'HH:MM:SS\', 90, 1, 1, 32, \'30\' );" );
