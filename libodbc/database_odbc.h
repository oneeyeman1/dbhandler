...
public:
    ...
    void GetConnectionPassword(const std::wstring &dsn, std::wstring &connectionPassword, std::vector<std::wstring> &errorMsg);
    ...
    virtual int GetTableCreationSyntax(const std::wstring &catalog, const std::wstring &schema, const std::wstring &tableName, std::vector<std::wstring> &syntax, std::vector<std::wstring> &errorMsg) override;
    ...
    virtual int GetCreateDBOptions(std::unique_ptr<CreateDBOptions> &options, std::vector<std::wstring> &errorMsg) override;
