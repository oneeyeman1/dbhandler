...
public:
    ...
    TableEditView *CreateDatabaseView(wxDocument *doc, ViewType type, std::map<wxString, wxDynamicLibrary *> &painters, ToolbarSetup &tbSetup, long flags);
    bool CreateDataEditDocument(const wxString &path, int flags, Database *db);
};
