...
extern "C" WXEXPORT void CreateDataEditWindow(wxWindow *parent, wxDocManager *docManager, Database *db, wxCriticalSection &cs)
{
...
//    dynamic_cast<TableEditDocument *>( docManager->GetCurrentDocument() )->SetDatabase( db, false );
}
