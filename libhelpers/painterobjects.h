...
public:
    ...
    virtual int ApplyProperties(Database *db, const wxAny &WXUNUSED(any), bool WXUNUSED(logOnlyy), std::wstring &WXUNUSED(command)) wxOVERRIDE { return 0; }
...
public:
    ...
    virtual int ApplyProperties(Database *db, const wxAny &any, bool logOnly, std::wstring &command) wxOVERRIDE { return 0; }
private:
