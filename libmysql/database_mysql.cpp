...
int MySQLDatabase::ApplyForeignKey(const std::wstring &command, const std::wstring &keyName, DatabaseTable &tableName, const std::vector<std::wstring> &foreignKeyFields, const std::wstring &refTableName, const std::vector<std::wstring> &refKeyFields, int deleteProp, int updateProp, std::vector<std::wstring> &errorMsg)
{
    int result = 0;
    char *str_data1 = NULL, *str_data2 = NULL, *str_data3 = NULL;
    MYSQL_STMT *stmt = NULL;
