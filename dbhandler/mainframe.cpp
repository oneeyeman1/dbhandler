...
MainFrame::MainFrame(wxDocManager *manager) : wxDocMDIParentFrame(manager, NULL, wxID_ANY, "DB Handler" )
{
    ...
    unsigned long temp = 0x000000;
    m_config->Read( "Background", &temp, 0xFFFFFF );
...
MainFrame::~MainFrame()
{
    ...
    m_config->SetPath( path );
    m_config->SetPath( "Database/Colors" );
    m_config->Write( "Background", m_conf->m_dbOptions.m_colors.m_background.GetRed() + m_conf->m_dbOptions.m_colors.m_background.GetGreen() * 256 + m_conf->m_dbOptions.m_colors.m_background.GetBlue() * 65536 );
    m_config->Write( "TableColumns", m_conf->m_dbOptions.m_colors.m_tableCol.GetRed() + m_conf->m_dbOptions.m_colors.m_tableCol.GetGreen() * 256 + m_conf->m_dbOptions.m_colors.m_tableCol.GetBlue() * 65536 );
    m_config->Write( "IndexKeyLiine", m_conf->m_dbOptions.m_colors.m_indexLine.GetRed() + m_conf->m_dbOptions.m_colors.m_indexLine.GetGreen() * 256 + m_conf->m_dbOptions.m_colors.m_indexLine.GetBlue() * 65536 );
    m_config->Write( "PrimaryKeyLine", m_conf->m_dbOptions.m_colors.m_primaryKeyLine.GetRed() + m_conf->m_dbOptions.m_colors.m_primaryKeyLine.GetGreen() * 256 + m_conf->m_dbOptions.m_colors.m_primaryKeyLine.GetBlue() * 65536 );
    m_config->Write( "TableHeader", m_conf->m_dbOptions.m_colors.m_tableHeader.GetRed() + m_conf->m_dbOptions.m_colors.m_tableHeader.GetGreen() * 256 + m_conf->m_dbOptions.m_colors.m_tableHeader.GetBlue() * 65536 );
    m_config->Write( "TableColumnText", m_conf->m_dbOptions.m_colors.m_tableColText.GetRed() + m_conf->m_dbOptions.m_colors.m_tableColText.GetGreen() * 256 + m_conf->m_dbOptions.m_colors.m_tableColText.GetBlue() * 65536 );
    m_config->Write( "TableHeaderText", m_conf->m_dbOptions.m_colors.m_tableHeaderText.GetRed() + m_conf->m_dbOptions.m_colors.m_tableHeaderText.GetGreen() * 256 + m_conf->m_dbOptions.m_colors.m_tableHeaderText.GetBlue() * 65536 );
    m_config->Write( "TableCommentText", m_conf->m_dbOptions.m_colors.m_tableCommentText.GetRed() + m_conf->m_dbOptions.m_colors.m_tableCommentText.GetGreen() * 256 + m_conf->m_dbOptions.m_colors.m_tableCommentText.GetBlue() * 65536 );
    m_config->Write( "ForeignKeyLine", m_conf->m_dbOptions.m_colors.m_foreignKeyLine.GetRed() + m_conf->m_dbOptions.m_colors.m_foreignKeyLine.GetGreen() * 256 + m_conf->m_dbOptions.m_colors.m_foreignKeyLine.GetBlue() * 65536 );
    m_config->SetPath( path );
    if( result )
    {
